            ...
            void create_pipeline(Command command, Resource<AssetServerGL> asset_server) {
                ...
                command.spawn(
                    PipelineBundle{
                        .shaders{
                            .vertex_shader =
                                asset_server->load_shader("../assets/shaders/pixel/shader.vert", GL_VERTEX_SHADER),
                            .fragment_shader =
                                asset_server->load_shader("../assets/shaders/pixel/shader.frag", GL_FRAGMENT_SHADER),
                        },
                        .attribs{
                            .attribs{
                    ...
                    for (auto [cam_trans, ortho_proj] : camera_query.iter()) {
                        for (auto [pixels, size, transform] : pixels_query.iter()) {
                            ...
                            glGetNamedBufferParameteriv(
                                pipeline.vertex_buffer.buffer, GL_BUFFER_SIZE, &vertex_buffer_size);
