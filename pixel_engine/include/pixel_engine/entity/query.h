...
namespace pixel_engine {
    namespace entity {
        ...
        namespace query {
            template <typename Get, typename Without>
            class Query {};

            template <typename... Qus, typename... Exs>
            class Query<Get<Qus...>, Without<Exs...>> {
               private:
            ...
            template <typename... Qus, typename... Exs>
            class Query<Get<entt::entity, Qus...>, Without<Exs...>> {
               private:
                entt::registry& registry;
                decltype(registry.view<Qus...>(entt::exclude_t<Exs...>{}).each()) m_iter;
            ...
            class Query2<Get<Qus...>, With<Ins...>, Without<Exs...>> {
               private:
                entt::registry& registry;
                decltype(registry.view<Qus..., Ins...>(entt::exclude_t<Exs...>{}).each()) m_iter;

               public:
                Query2(entt::registry& registry) : registry(registry) {
            ...
            template <typename... Qus, typename... Ins, typename... Exs>
            class Query2<Get<entt::entity, Qus...>, With<Ins...>, Without<Exs...>> {
               private:
                entt::registry& registry;
                decltype(registry.view<Qus..., Ins...>(entt::exclude_t<Exs...>{}).each()) m_iter;
        ...
        template <typename Get, typename Without>
        using Query = query::Query<Get, Without>;

        template <typename Get, typename With, typename Without>
        using Query2 = query::Query2<Get, With, Without>;
    }  // namespace entity
}  // namespace pixel_engine